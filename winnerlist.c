...
void s_winner(p_s start) 
{ 
    int swapped, i; 
    struct p_swim_node *ptr1; 
    struct p_swim_node *lptr = NULL; 
    ...
    { 
        ...
        while (ptr1->s_next != lptr) 
        { 
            if (ptr1->sscore.s_points < ptr1->s_next->sscore.s_points) 
            {  
                swap_s(ptr1, ptr1->s_next); 
                swapped = 1; 
            } 
            ptr1 = ptr1->s_next; 
        } 
...
void a_winner(p_a start) 
{ 
    int swapped, i; 
    struct p_ath_node *ptr1; 
    struct p_ath_node *lptr = NULL; 
    ...
    { 
        ...
        while (ptr1->a_next != lptr) 
        { 
            if (ptr1->ascore.a_points < ptr1->a_next->ascore.a_points) 
            {  
                swap_a(ptr1, ptr1->a_next); 
                swapped = 1; 
            } 
            ptr1 = ptr1->a_next; 
        } 
